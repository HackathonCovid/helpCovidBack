...
// CreateToken : funct to create a token for the user
...
// TokenValid : verify if the token is still valid
...
// ExtractToken : extraction of token
...
// ExtractTokenID : extraction of token id
